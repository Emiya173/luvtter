...
class AttachmentService {
    ...
    fun addPhoto(userId: Uuid, letterId: Uuid, req: AddPhotoAttachmentRequest): AttachmentDto = transaction {
        ...
        log.info { "attachment.addPhoto letter=$letterId weight=${req.weight}" }
        LetterAttachments.selectAll().where { LetterAttachments.id eq id }.first().toDto()
    }
    ...
    private fun ResultRow.toDto() = AttachmentDto(
        ...
        mediaUrl = this[LetterAttachments.mediaUrl],
