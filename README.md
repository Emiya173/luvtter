...
| `composeApp/src/commonMain/kotlin/com/letter/app/App.kt` | 客户端 UI 入口 + NavHost |
| `composeApp/src/commonMain/kotlin/com/letter/app/di/AppModule.kt` | 客户端 Koin 装配 |
...
| `shared/src/commonMain/kotlin/com/letter/shared/network/` | 客户端网络层(各 *Api*,含 `NotificationApi.stream()` SSE) |
| `server/src/main/kotlin/com/letter/server/di/Modules.kt` | 服务端按域 Koin 模块 |
| `server/src/test/kotlin/com/letter/server/` | testcontainers 集成测试 |
